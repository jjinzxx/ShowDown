...
public:
	...
	// Session delegates historically used bSuccess=false for both progress and
	// failures. Keep only actionable failures in the persistent screen status.
	static bool ShouldDisplayEosSessionStatus(
		bool bSuccess,
